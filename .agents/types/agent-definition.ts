...
export interface AgentDefinition {
  ...
  /** AI model to use for this agent. Specify a model identifier (see https://openrouter.ai/models for available models) */
  model: ModelName
...
/**
 * AI models available for agents. Pick from our selection of recommended models or specify any supported model identifier.
 *
